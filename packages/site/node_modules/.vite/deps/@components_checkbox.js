// ../../.yarn/cache/@components-checkbox-https-d7aaaf3acd-149aa51133.zip/node_modules/@components/checkbox/index.ts
var Checkbox = class extends HTMLElement {
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    switch (name) {
      case "label":
        ...
        break;
      case "checked":
        this.checked = (newValue == null ? void 0 : newValue.toLowerCase()) === "true" || newValue === "";
        break;
      case "right":
        this.right = (newValue == null ? void 0 : newValue.toLowerCase()) === "true" || newValue === "";
        break;
      default:
        break;
    }
  ...
  connectedCallback() {
    ...
    this.checked = (checked == null ? void 0 : checked.toLowerCase()) === "true" || checked === "";
    this.label = this.getAttribute("label") || "";
    const right = this.getAttribute("right");
    this.right = (right == null ? void 0 : right.toLowerCase()) === "true" || right === "";
  }
  get checked() {
...
//# sourceMappingURL=@components_checkbox.js.map
